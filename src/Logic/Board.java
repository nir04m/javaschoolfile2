...
public class Board{
	...
	private ArrayList <Point> coord = new ArrayList<Point> (Arrays.asList( new Point(750,800), new Point(650,800), new Point(550,800), new Point(450,800), new Point(350,800),
		new Point(250,800), new Point(150,800), new Point(50,800), new Point(100,700), new Point(100,600), new Point(100,500), new Point(100,400), new Point(100,300), 
		new Point(100,200), new Point(50,100), new Point(150,100), new Point(250,100), new Point(350,100), new Point(450,100), new Point(550,100), new Point(650,100), 
		new Point(750,100), new Point(800,200), new Point(800,300), new Point(800,400), new Point(800,500), new Point(800,600), new Point(800,700)));
	//instance varibales
	private final static ArrayList <Integer> rent = new ArrayList<Integer> (Arrays.asList(0, 5, 5, 200, 100, 10, 15, 0, 20, 20, 25, 0, 30, 35, 100, 40, 40, 45, 200, 
			100, 120, 300, 150, 100, 170, 0, 200, 220));
	private final static ArrayList <Integer> value = new ArrayList <Integer> (Arrays.asList(0, 60, 70, 200, 200, 100, 150, 0, 170, 170, 190, 0, 210, 220, 0, 240, 240, 
			260, 200, 280, 300, 300, 320, 200, 340, 0, 350, 400));
	private final static ArrayList <String> propertyNames = new ArrayList <String> (Arrays.asList("Go" , " Meditranian Ave.", "Baltic Ave.", "INCOME TAX", "Railroad 1", 
			"Oriental Ave.", "Vermont Ave.", "Just visiting jail", "St. Charels", "States Ave.", "Virginia Ave.", "Community card", "St. James", "NYC Ave.", "Free Parking", 
			"Kentucky Ave.", "Indiana Ave.", "Illinos Ave.", "Luxary Tax", "Atlantic Ave.", "Ventnor Ave.", "Jail", "Pacific Ave.", "Railroad 2", "Carolina Ave.", 
			"Community card", "Park Place", "BoardWalk"));
